...
public class JsonUtil {
     ...
     * @param jsonType 类型（jackson,gson,fastson）
     * @return 返回Map
     */
    public static Map toMap(String json, String jsonType) {
     ...
     * @return 返回List
     */
    public static List toList(String json, String jsonType) {
        if (!Objects.isNull(jsonType)) {
            classType = jsonType;
        }
     ...
     * @return 返回List
     */
    public static <T> List<T> toTypeReferenceList(String json, String jsonType, final Type type) {
        if (!Objects.isNull(jsonType)) {
            classType = jsonType;
        }
     ...
     * @return 返回对象的json字符串
     */
    public static String toJsonString(Object object, String jsonType) {
        if (!Objects.isNull(jsonType)) {
            classType = jsonType;
        }
    ...
    public static String toJsonWithDateFormat(Object object, String dateFormatPattern) {
        ...
        return toJsonWithDateFormat(object, null, dateFormatPattern);
    }
     ...
     * @return 返回对象的json字符串
     */
    public static String toJsonWithDateFormat(Object object, String jsonType, String dateFormatPattern) {
        if (!Objects.isNull(jsonType)) {
            classType = jsonType;
        }
    ...
    public static <T> T toPojo(String json, Class<T> valueType) {
        ...
        return toPojo(json, null, valueType);
    }
     ...
     * @return 返回解析后的对象
     */
    public static <T> T toPojo(String json, String jsonType, Class<T> valueType) {
        if (!Objects.isNull(jsonType)) {
            classType = jsonType;
        }
    ...
    public static Map convertToMap(Object fromValue) {
        ...
        return convertToMap(fromValue, null);
    }
     ...
     * @return 返回Map对象
     */
    public static Map convertToMap(Object fromValue, String jsonType) {
        if (!Objects.isNull(jsonType)) {
            classType = jsonType;
        }
    ...
    public static <T> T convertFromMap(Map fromMap, Class<T> toValueType) {
        ...
        return convertFromMap(fromMap, null, toValueType);
    }
     ...
     * @return 返回Map转换得到的对象
     */
    public static <T> T convertFromMap(Map fromMap, String jsonType, Class<T> toValueType) {
        if (!Objects.isNull(jsonType)) {
            classType = jsonType;
        }
